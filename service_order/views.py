...
from service_order.models import Contact, Category, Shop, ProductInfo, Order, OrderItem, ProductParameter, Parameter, Product
...
from service_order.signals import new_order, new_user_registered
